...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RichFile', fields ['type']
        db.delete_unique(u'johnnywalker_richfile', ['type'])


    def backwards(self, orm):
        # Adding unique constraint on 'RichFile', fields ['type']
        db.create_unique(u'johnnywalker_richfile', ['type'])
