...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'webui_project', 'desc',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'webui_project', 'desc')
    ...
    models = {
        ...
        u'webui.projectdomain': {
            ...
            'starttime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
