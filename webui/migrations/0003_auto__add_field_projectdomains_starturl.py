...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectDomains.starturl'
        db.add_column(u'webui_projectdomains', 'starturl',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectDomains.starturl'
        db.delete_column(u'webui_projectdomains', 'starturl')
    ...
    models = {
        ...
        u'webui.projectdomains': {
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
