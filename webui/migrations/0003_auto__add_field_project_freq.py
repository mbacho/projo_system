...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.freq'
        db.add_column(u'webui_project', 'freq',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.freq'
        db.delete_column(u'webui_project', 'freq')
    ...
    models = {
        ...
        u'webui.project': {
            'Meta': {'ordering': "['-created']", 'unique_together': "(('name', 'owner'),)", 'object_name': 'Project'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'desc': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'freq': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'webui.projectdomain': {
            ...
            'starttime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
